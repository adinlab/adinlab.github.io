...
<div class="row justify-content-center">
    <div class="mt-3 mt-md-0" style="width: 62.5%; max-width: 100%;">
...
* **(S+N)** One can learn an isomorphism of the latent dynamics of a controlled Markov process from hitting time observations, which can be used to train foundation policies. See our [IEL algorithm](https://arxiv.org/abs/2605.06470) (Boock et al., arXiv, 2026).
* **(N)** Reconstructing reinforcement learning theory from measure-theoretic foundations explains why deep actor-critics work well. See our [MTRL framework](https://arxiv.org/abs/2605.05791) (Haussmann et al., arXiv, 2026).
